...
whyThisApp <- tagList(
  ...
  p("I created this app as a way of showing my friends what words, 'look like' in my mind's eye. I was heavily inspired by Bernadette Sheridan's ", 
...
moreAboutSynesthesia <- tagList(
  ...
  tags$ul(
    tags$li("Bernadette Sheridan's website, ", a(href = "https://synesthesia.me/about", "synesthesia.me"), ", which inspired greenT"), 
...
acknowledgments <- tagList(
  ...
  tags$ul(
    ...
    tags$li("Bernadette Sheridan, whose original", a(href = "https://synesthesia.me/", "synesthesia.me"), " project inspired me to create this app in the first place.")
  ),
  br(),
  br()
)

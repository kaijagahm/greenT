    ...
    fluidRow(
      bsCollapse( # creates an environment in which collapsible panels can live
        ...
        bsCollapsePanel(
          ...
          column(width = 2,
                 colourInput("a", "A", value = randomColor(), showColour = "background"),
                 colourInput("g", "G", value = randomColor(), showColour = "background"),
                 colourInput("m", "M", value = randomColor(), showColour = "background"),
                 colourInput("s", "S", value = randomColor(), showColour = "background"),
                 colourInput("y", "Y", value = randomColor(), showColour = "background"),
                 colourInput("five", "5", value = randomColor(), showColour = "background")), 
          column(width = 2,
                 colourInput("b", "B", value = randomColor(), showColour = "background"),
                 colourInput("h", "H", value = randomColor(), showColour = "background"),
                 colourInput("n", "N", value = randomColor(), showColour = "background"),
                 colourInput("t", "T", value = randomColor(), showColour = "background"),
                 colourInput("z", "Z", value = randomColor(), showColour = "background"),
                 colourInput("six", "6", value = randomColor(), showColour = "background")),
          column(width = 2,
                 colourInput("c", "C", value = randomColor(), showColour = "background"),
                 colourInput("i", "I", value = randomColor(), showColour = "background"),
                 colourInput("o", "O", value = randomColor(), showColour = "background"),
                 colourInput("u", "U", value = randomColor(), showColour = "background"),
                 colourInput("one", "1", value = randomColor(), showColour = "background"),
                 colourInput("seven", "7", value = randomColor(), showColour = "background")),
          column(width = 2,
                 colourInput("d", "D", value = randomColor(), showColour = "background"),
                 colourInput("j", "J", value = randomColor(), showColour = "background"),
                 colourInput("p", "P", value = randomColor(), showColour = "background"),
                 colourInput("v", "V", value = randomColor(), showColour = "background"),
                 colourInput("two", "2", value = randomColor(), showColour = "background"),
                 colourInput("eight", "8", value = randomColor(), showColour = "background")),
          column(width = 2,
                 colourInput("e", "E", value = randomColor(), showColour = "background"),
                 colourInput("k", "K", value = randomColor(), showColour = "background"),
                 colourInput("q", "Q", value = randomColor(), showColour = "background"),
                 colourInput("w", "W", value = randomColor(), showColour = "background"),
                 colourInput("three", "3", value = randomColor(), showColour = "background"),
                 colourInput("nine", "9", value = randomColor(), showColour = "background")),
          column(width = 2,
                 colourInput("f", "F", value = randomColor(), showColour = "background"),
                 colourInput("l", "L", value = randomColor(), showColour = "background"),
                 colourInput("r", "R", value = randomColor(), showColour = "background"),
                 colourInput("x", "X", value = randomColor(), showColour = "background"),
                 colourInput("four", "4", value = randomColor(), showColour = "background"),
                 colourInput("zero", "0", value = randomColor(), showColour = "background")),
          fluidRow(
            column(width = 12,
